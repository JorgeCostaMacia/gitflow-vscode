...
/** Use case: start a bugfix branch from develop and publish it. */
export class BugfixStartService {
  ...
  /** Creates `bugfix/<name>-<timestamp>` from develop. Returns the created branch. */
